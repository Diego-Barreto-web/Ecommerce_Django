    ...
    if request.method == 'POST':
        if request.user.is_authenticated:
            ...
            if request.COOKIES.get('id_sessao'):
                ...
                return redirect('loja')
        dados = request.POST.dict()
        endereco = Endereco.objects.create(cliente=cliente, rua=dados.get('rua'), cidade=dados.get('cidade'), estado=dados.get('estado'), numero=int(dados.get('numero')), complemento=dados.get('complemento'), cep=dados.get('cep'))
        endereco.save()
